/******************************************************************************
 *  Description     : This file contains the main helper functions used in the 
 						Mantis card game. It manages player setup, deck loading 
						and shuffling, card drawing, scoring and stealing 
						mechanics, win checking, statistics tracking, and settings 
						configuration. It also handles file operations for loading 
						and saving player data from players.txt and card data from
						mantis.txt to support modular game logic and user interaction.
